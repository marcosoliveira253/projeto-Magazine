...
function desenharProdutoNoCarrinho(idProduto) {
    ...
    const cartaoProdutoCarrinho = `<button id="remover-item-${produto.id}" class="absolute top-0 right-2"><i class="fa-solid fa-trash-can text-slate-500 hover:text-slate-800"></i></button>
